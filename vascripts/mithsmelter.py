...
bot.gui.regions = [
    ...
    {'x': 856, 'y': 428, 'width': 109, 'height': 20, 'color': '#FF0000'},
    {'x': 675, 'y': 798, 'width': 36, 'height': 48, 'color': '#FF0000'},
    {'x': 679, 'y': 875, 'width': 70, 'height': 26, 'color': '#FF0000'},
]
...
while bot.is_running:
    ...
    bot.click_region(region_index=13, button='right')
