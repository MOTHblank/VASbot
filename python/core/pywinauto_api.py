...
class PywinautoBot:
    ...
    def get_window(self, title: Optional[str] = None, 
                   class_name: Optional[str] = None,
                   process: Optional[int] = None) -> Any:
        """
        ...
        try:
            ...
            if process:
                ...
                raise PywinautoError("At least one of title, class_name, or process must be provided")
            
            # Verify window exists
            if not window.exists():
                raise WindowNotFoundError(f"Window not found: title='{title}', class_name='{class_name}', process={process}")
    ...
    def list_windows(self, title: Optional[str] = None, 
    ...
    def _find_control(self, window: Any, control_type: Optional[str], identifier: str) -> Any:
        """
        ...
        try:
            ...
            methods = [
                ...
                lambda: window.child_window(title=identifier, control_type=control_type) if control_type else window.child_window(title=identifier),
                lambda: window[control_type + identifier] if control_type else window[identifier],
            ]
    ...
    def click_element(self, window: Any, control_type: str, 
                      identifier: str, double_click: bool = False) -> bool:
        """
    ...
    def type_into(self, window: Any, control_identifier: str, 
    ...
    def select_dropdown(self, window: Any, control_identifier: str, 
                        value: str, by_index: bool = False) -> bool:
        """
    ...
    def check_checkbox(self, window: Any, control_identifier: str, 
    ...
    def get_all_controls(self, window: Any, 
                    ...
                    for child in children:
                        try:
                            ...
                            ctrl_info = {
                                ...
                                'control_id': child.control_id() if hasattr(child, 'control_id') else None,
    ...
    def wait_for_element(self, window: Any, control_identifier: str, 
    ...
    def get_focused_element_info(self, window: Any) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'control_id': focused.control_id() if hasattr(focused, 'control_id') else None,
            }
        except Exception as e:
