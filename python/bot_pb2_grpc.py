...
class BotServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.UpdateRegions = channel.unary_unary(
                ...
                _registered_method=True)
        self.UpdateColorClusters = channel.unary_unary(
                '/vasbot.BotService/UpdateColorClusters',
                request_serializer=bot__pb2.ColorClusterList.SerializeToString,
                response_deserializer=bot__pb2.UpdateResponse.FromString,
                _registered_method=True)
        ...
        self.WaitWindow = channel.unary_unary(
                ...
                response_deserializer=bot__pb2.UpdateResponse.FromString,
                _registered_method=True)
        self.DetectShapes = channel.unary_unary(
                '/vasbot.BotService/DetectShapes',
                request_serializer=bot__pb2.ShapeDetectionRequest.SerializeToString,
                response_deserializer=bot__pb2.ShapeDetectionResponse.FromString,
                _registered_method=True)
...
def add_BotServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UpdateColorClusters': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateColorClusters,
                    request_deserializer=bot__pb2.ColorClusterList.FromString,
                    response_serializer=bot__pb2.UpdateResponse.SerializeToString,
            ),
            ...
            'DetectShapes': grpc.unary_unary_rpc_method_handler(
                    servicer.DetectShapes,
                    request_deserializer=bot__pb2.ShapeDetectionRequest.FromString,
                    response_serializer=bot__pb2.ShapeDetectionResponse.SerializeToString,
            ),
    }
...
class BotService:
    ...
    @staticmethod
    def UpdateColorClusters(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/vasbot.BotService/UpdateColorClusters',
            bot__pb2.ColorClusterList.SerializeToString,
            bot__pb2.UpdateResponse.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def DetectShapes(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/vasbot.BotService/DetectShapes',
            bot__pb2.ShapeDetectionRequest.SerializeToString,
            bot__pb2.ShapeDetectionResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
